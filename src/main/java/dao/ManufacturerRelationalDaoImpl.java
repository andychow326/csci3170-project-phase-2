...
public class ManufacturerRelationalDaoImpl extends DaoImpl<ManufacturerRelationalDaoImpl>
        implements ManufacturerRelationalDao {

    public ManufacturerRelationalDaoImpl(Connection conn) {
        super(conn);
    }
